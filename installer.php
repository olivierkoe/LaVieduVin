...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'lavieduvinKOENIGOlivier_29933b7360458e1a7748_20220331141412_archive.zip';
	const ARCHIVE_SIZE		 = '65544210';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '29933b7-31141412';
    const SECONDARY_PACKAGE_HASH = 'eced623-31141412';
	const VERSION			 = '1.4.4';
