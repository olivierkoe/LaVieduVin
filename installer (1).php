...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'lavieduvinKOENIGOlivierV2_0230aedebaf1c9f57621_20220331144536_archive.zip';
	const ARCHIVE_SIZE		 = '65555184';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0230aed-31144536';
    const SECONDARY_PACKAGE_HASH = 'faf3182-31144536';
	const VERSION			 = '1.4.4';
